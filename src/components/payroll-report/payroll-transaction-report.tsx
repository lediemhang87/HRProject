...
const PayrollTransactionReport: React.FC = () => {
    ...
    const [sortColumn, setSortColumn] = useState<keyof PayrollTransaction>('dateAndTime');
    ...
    const handleSort = (column: keyof PayrollTransaction) => {
    ...
    return (
        <div className="border p-4 rounded shadow-sm bg-white mb-4"> 
            <div className="fw-bold"> Payroll Transaction Report </div>
...
export default PayrollTransactionReport